...
public class SalesforceConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    private String sendRequestAndGetString(String url, String requestFile, String action, String header, String body) throws Exception {
        SOAPEnvelope response = sendSOAPRequest(url, requestFile, null, action, header, body);
    ...
    public void testGetUserInfoWithMandatoryParameters() throws Exception {
        String esbSoapResponse = sendRequestAndGetString(proxyUrl, "esbGetUserInfoMandatory.xml", "mediate", SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
        ...
        String apiSoapResponse = sendRequestAndGetString(apiEndPoint, "apiLogin.xml", "login", SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
        ...
        apiSoapResponse = sendRequestAndGetString(serverUrl, "apiGetUserInfoMandatory.xml", "getUserInfo", SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

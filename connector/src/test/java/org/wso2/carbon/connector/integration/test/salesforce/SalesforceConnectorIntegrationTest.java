...
public class SalesforceConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    private String requestFileBase = TestConfigurationProvider.getResourceLocation() + "artifacts" + File.separator +
            "ESB" + File.separator + "config" + File.separator + "soapRequests" + File.separator + "salesforce" +
            File.separator;
...
//        String esbResponseBody = sendSOAPRequestNew(proxyUrl, "esbGetUserInfoMandatory.xml", "mediate");
//        String esbUserEmail = getTagFromSOAPMessage(esbResponseBody, "userEmail");
//        String esbUserId = getTagFromSOAPMessage(esbResponseBody, "userId");
//
//        String apiResponseBody = sendSOAPRequestNew(apiEndPoint, "apiLogin.xml", "login");
//        String session = getTagFromSOAPMessage(apiResponseBody, "sessionId");
//        connectorProperties.put("session", session);
//        String serverUrl = getTagFromSOAPMessage(apiResponseBody, "serverUrl");
//        connectorProperties.put("serverUrl", serverUrl);
//
//        String apiResponseBody2 = sendSOAPRequestNew(serverUrl, "apiGetUserInfoMandatory.xml", "getUserInfo");
//        String apiUserEmail = getTagFromSOAPMessage(apiResponseBody2, "userEmail");
//        String apiUserId = getTagFromSOAPMessage(apiResponseBody2, "userId");
//
//        Assert.assertEquals(esbUserEmail, apiUserEmail);
//        Assert.assertEquals(esbUserId, apiUserId);
//    }
//
//    private String getTagFromSOAPMessage(String soapMessageString, String tag) throws SOAPException, IOException {
...
//    private String sendSOAPRequestNew(String url, String requestFileName, String soapAction) throws IOException {
//        PostMethod post = new PostMethod(url);
//        String request = loadRequestFromFile(requestFileName, null);
...
//
//        SOAPEnvelope esbSoapResponseCreate2 = sendSOAPRequest(proxyUrl, "esbCreateLeadMandatory.xml", null, "mediate",
//                SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
//        OMElement esbResponseElementCreate2 = AXIOMUtil.stringToOM(esbSoapResponseCreate2.getBody().toString());
//        String id2 = (String) xPathEvaluate(esbResponseElementCreate2, xPathExp, nameSpaceMap);
//        connectorProperties.put("idForConvert2", id2);
//
//        SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl, "esbConvertLeadMandatory.xml", null, "mediate",
//                SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
//        OMElement esbResponseElement = AXIOMUtil.stringToOM(esbSoapResponse.getBody().toString());

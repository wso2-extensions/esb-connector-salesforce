# Configuring the Salesforce Fault Handler Sequence

Following is a sample proxy service and fault handler sequence you can use as a starting point for handling faults when integrating with Salesforce. Customize this sample to match your requirements.
